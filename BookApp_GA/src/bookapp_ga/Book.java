...
//            System.out.print("Enter title: ");
            newBk.setTitle(title.replace(' ', '-'));
            String author = JOptionPane.showInputDialog("Enter author:");
//            System.out.print("Enter author: ");
            newBk.setAuthor(author.replace(' ', '-'));
            String isbn = JOptionPane.showInputDialog("Enter ISBN:");
//            System.out.print("Enter ISBN: ");
            newBk.setISBN(isbn);
            String genre = JOptionPane.showInputDialog("Enter genre:");
//            System.out.print("Enter main genre: ");
            newBk.setGenre(genre);
            boolean price = false;
            while (!price){
                String p = JOptionPane.showInputDialog("Enter price: RM");
                System.out.print("Enter price: RM ");
                try{
                    newBk.setPrice(Double.parseDouble(p));
                    price = true;
                }catch (NumberFormatException e){
                    JOptionPane.showMessageDialog(null, "Please enter numerical input.");
//                    System.out.println("Please enter numerical input.");
            ...
            String option = JOptionPane.showInputDialog("Add more books? \n Enter 'Y' to add more books. \n Enter any other key to continue. ");
...
//            String next = input.nextLine();
    ...
    public static void editBook() throws Exception, IOException{
        ...
        while (more){
            ...
            //Set ListIterator
            lit = v.listIterator();
            JOptionPane.showMessageDialog(null, "Edit Book Information");
...
/***             String details = JOptionPane.showMessageDialog(null, lit.nextIndex() + ". Title: " + bk.getTitle() + "\tAuthor: " + bk.getAuthor() + "\tISBN: " + bk.getISBN() + "\tGenre: " + bk.getGenre() + "\tPrice: RM " + bk.getPrice());
...
//                int selection = JOptionPane.showInputDialog("Select a book that you wish to edit. ");
                ...
                while (edit){
                    ...
                    JOptionPane.showMessageDialog(null, "Select an information that you wish to edit: ");
//                    System.out.println("Select an information that you wish to edit: ");
                    String info = JOptionPane.showInputDialog("1. Title \t 2. Author \t 3. ISBN \t 4. Genre \t 5. Price  \nEnter any other key if you do not wish to make any edits..");
...
//                    String info = input.nextLine();
                    ...
                    switch (info){
                        case "1":
                            String title = JOptionPane.showInputDialog("Enter title: ");
//                            System.out.print("Enter Title: ");
                            v.get(select).setTitle(title);
                            break;
                        case "2":
                            String author = JOptionPane.showInputDialog("Enter author: ");
//                            System.out.print("Enter Author: ");
                            v.get(select).setAuthor(author);
                            break;
                        case "3":
                             String isbn = JOptionPane.showInputDialog("Enter ISBN: ");
//                            System.out.print("Enter ISBN: ");
                            v.get(select).setISBN(isbn);
                            break;
                        case "4":
                            String genre = JOptionPane.showInputDialog("Enter genre: ");
//                            System.out.print("Enter Genre: ");
                            v.get(select).setGenre(genre);
                            break;
                        case "5":
                            boolean price = false;
                            while (!price){
...
//                                    System.out.print("Enter Price: RM ");
                                try{
                                    v.get(select).setPrice(Double.parseDouble(p));
                                    price = true;
                                }catch(NumberFormatException e){
                                    JOptionPane.showMessageDialog(null, "Please enter numerical input.");
//                                    System.out.println("Please enter numerical input.");
                            ...
                            break;
                        default:
                            JOptionPane.showMessageDialog(null, "You did not edit any of the information. ");
//                            System.out.println("You did not edit any of the information. ");
                   ...
                   JOptionPane.showMessageDialog(null, "You did not select any book. ");
//                 System.out.println("You did not select any book.");
                break;
            }
            
            // Asks if user wish to edit any other book
            String decision = JOptionPane.showInputDialog("Do you wish to edit any other books? \n Enter 'Y' to edit more books. \n Enter any other key if you do not wish to make any more edits.");
